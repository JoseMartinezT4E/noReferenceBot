...
public class ControllerMap {
	...
	// This is the ControlMap. All buttons, sticks, triggers, and controllers need a mapping to know which 
	// button is which on the Xbox Controller. Through these mappings, we can use these objects and assign
	// them to commands
